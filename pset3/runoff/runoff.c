...
{
    // TODO
    for (int i = 0; i < voter_count; i++) // continue looking for votes
    {

        for (int j = 0; j < candidate_count; j++) // looking for rank
        {
...
{
    // TODO
    int first_non_eliminated_count = -1;// finding min number of votes and candidate has
    ...
    for (int i = 0; i < candidate_count; i++)// returning all non eliminated candidates
    {
